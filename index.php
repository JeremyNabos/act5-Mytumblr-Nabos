...
$acc_username = "JeremyNabos";
$acc_password = "jeremy69";
$acc_fullname = "Jeremy Albis Nabos";
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			else if(isset($_REQUEST['success']) === true)
		      			{
		      				...
		      				echo "<div class='alert alert-warning' role='alert'> You are still Logged in. Click <a href='account.php'> here to proceed. </div>";
		      			}
